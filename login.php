...
<body class="bg-light">
    <div class="container-fluid">
        ...
        <a href="./reset-password.php" id="forgot_password" data-target="#forgotPasswordModal" div class="form-sub-msg">Forgot Password?</a>
...
<div id="button_container" class="text-center mt-3" name="submit">
                        ...
                        <p id="create_account_text" class="text-center mt-3">Don't have an account? <br> Create a new one <a href="signup.php"> here</a></p>
